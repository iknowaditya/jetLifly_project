      ...
      <section className="bg-white ">
        <div className="relative items-center w-full px-5 pt-24 mx-auto md:px-12 lg:px-16 max-w-7xl lg:py-24 ">
          <div className="flex justify-center items-center ">
            <h1 className="text-5xl font-bitter_heading font-semibold ">
              Why{" "}
          ...
          <div className="mt-28 ">
            <div className="max-w-2xl ">
              <p className="text-2xl font-medium tracking-tight text-black sm:text-3xl">
                Experience luxury with precision, setting a new standard in
                private jet services.
              </p>
              <p className="max-w-2xl mt-4 text-[18px] tracking-tight text-gray-600 font-bitter_heading ">
                Experience unmatched luxury and convenience with our exclusive
                private jet services. Our commitment to personalized itineraries
                ensures a seamless and sophisticated travel experience.
              </p>
            </div>
                ...
                <div>
                  <div className="grid grid-cols-2 gap-12 lg:grid-cols-3 lg:space-y-0">
                    <div>
                      ...
                      <div className="mt-4 text-base text-gray-500 font-bitter_heading ">
                        Experience a diverse range of private jets tailored to
                        meet your specific travel needs.
                      </div>
                    </div>
                    <div>
                      <div>
                      ...
                      <div className="mt-4 text-base text-gray-500 font-bitter_heading ">
                        Enjoy a hassle-free booking process with our
                    ...
                    <div>
                      ...
                      <div className="mt-4 text-base text-gray-500 font-bitter_heading ">
                        Safety is our top priority. Our fleet meets industry
                        standards, ensuring meticulous maintenance for your
                        peace of mind.
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="mt-4 text-base text-gray-500 font-bitter_heading ">
                        Experience unparalleled personalized service from our
                        dedicated team.
                      </div>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <div className="mt-4 text-base text-gray-500 font-bitter_heading ">
                        Benefit from competitive and transparent pricing without
                    ...
                    <div>
                      ...
                      <div className="mt-4 text-base text-gray-500 font-bitter_heading ">
                        Our round-the-clock customer support is here to assist
                        you at every step.
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="mt-4 text-base text-gray-500 font-bitter_heading ">
                        Join our exclusive membership program and unlock a world
                        of benefits.
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="mt-4 text-base text-gray-500 font-bitter_heading ">
                        Commit to eco-friendly travel with our focus on
                        sustainability.
                      </div>
                    </div>
                  </div>
